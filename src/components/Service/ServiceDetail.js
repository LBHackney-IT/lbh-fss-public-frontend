  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (
        ...
        Object.entries(urlParams)[0][0] == "support_service" &&
        Object.entries(urlParams)[0][1] !== ""
      ) {
        serviceId = parseInt(Object.entries(urlParams)[0][1]);
      }
      const getService = await GetServices.getService({
        id: serviceId,
      ...
      <div className="service-info">
            ...
            <AccordionContainer>
              ...
              <Accordion allowMultipleExpanded preExpanded={["hidden"]}>
                {data.service.categories.map((category) => {
                  const categoryIconName = category.name
                    .replaceAll(" ", "-")
                    .toLowerCase();
                  const categoryIcon = categoryIconMap[categoryIconName] || [
                    "fas",
                    "circle",
                  ];
                  return (
                    <AccordionItem key={category.id}>
                      ...
                      >
                        <AccordionItemButton>
                          ...
                          <FontAwesomeIcon
                            icon={["fas", "plus"]}
                            className="accordion-chevron accordion-chevron--closed"
                          />
                          <FontAwesomeIcon
                            icon={["fas", "minus"]}
                            className="accordion-chevron accordion-chevron--open"
                          />
                        </AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>{category.description}</AccordionItemPanel>
                    </AccordionItem>
                  );
                })}
            ...
            <ul className="ul-no-style">
                ...
                <>
                  <li className="no-print">
                    <a
                      ...
                      href={data.service.contact.website}
                      target="_blank"
                  ...
                  <li className="print-only">
                    <a className="link-button" href={data.service.contact.website}>
                      Visit website: {data.service.contact.website}
                    </a>
                  </li>
                </>
              ) : null}
              {data.service.contact.telephone ? (
                <li>
                  ...
                  <a href={`tel://${data.service.contact.telephone}`}>
                    {data.service.contact.telephone}
                  </a>
                </li>
              ) : null}
              {data.service.contact.email ? (
                <li>
                  ...
                  <a href={`mailto:${data.service.contact.email}`}>
                    {data.service.contact.email}
                  </a>
                </li>
              ) : null}
        ...
        {hasReferral ? (
          <InnerContainer>
            ...
            <ul className="ul-no-style">
              {data.service.referral.website ? (
                <li>
                  <FontAwesomeIcon icon={["fas", "external-link-square-alt"]} />
                  <a
                    href={data.service.referral.website}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Visit website
                    <span className="print-only">: {data.service.referral.website}</span>
                  </a>
                </li>
              ) : null}
              {data.service.referral.email ? (
                <li>
                  <FontAwesomeIcon icon={["fas", "envelope"]} />
                  <a href={`mailto:${data.service.referral.email}`}>
                    {data.service.referral.email}
                  </a>
                </li>
              ) : null}
        ...
        {hasSocial ? (
          <InnerContainer>
            ...
            <ul className="ul-no-style">
              {data.service.social.facebook ? (
                <li>
                  <FontAwesomeIcon icon={["fab", "facebook-square"]} />
                  <a
                    href={data.service.social.facebook}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Facebook
                    <span className="print-only">: {data.service.social.facebook}</span>
                  </a>
                </li>
              ) : (
                ""
              )}
              {data.service.social.twitter ? (
                <li>
                  <FontAwesomeIcon icon={["fab", "twitter-square"]} />
                  <a
                    href={data.service.social.twitter}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Twitter
                    <span className="print-only">: {data.service.social.twitter}</span>
                  </a>
                </li>
              ) : (
                ""
              )}
              {data.service.social.instagram ? (
                <li>
                  <FontAwesomeIcon icon={["fab", "instagram-square"]} />
                  <a
                    href={data.service.social.instagram}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Instagram
                    <span className="print-only">: {data.service.social.instagram}</span>
                  </a>
                </li>
              ) : (
                ""
              )}
              {data.service.social.linkedin ? (
                <li>
                  <FontAwesomeIcon icon={["fab", "linkedin"]} />
                  <a
                    href={data.service.social.linkedin}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    LinkedIn
                    <span className="print-only">: {data.service.social.linkedin}</span>
                  </a>
                </li>
              ) : (
                ""
