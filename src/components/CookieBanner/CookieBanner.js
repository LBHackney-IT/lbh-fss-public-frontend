...
const CookieBannerDisplay = () => {
  ...
  return (
    <section
      ...
      style={{ background: "#00664F" }}
    >
      <div className="lbh-container">
        <div className="govuk-grid-row">
          <div className="lbh-cookie-banner__content govuk-grid-column-two-thirds-from-desktop">
            <p>
              We use cookies to ensure you have the best experience. For full details see
              our <a href="https://hackney.gov.uk/privacy">privacy statement</a>.
            </p>
          </div>
